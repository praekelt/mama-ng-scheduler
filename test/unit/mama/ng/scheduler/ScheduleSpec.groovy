...
class ScheduleSpec extends Specification {
    ...
    void "test everything works"() {
            use (TimeCategory) {
                schedule.subscriptionId = "user-id"
    ...
    void "test blank user id"() {
        ...
        expect:
            schedule.hasErrors()
            schedule.errors["subscriptionId"].toString().contains("blank")
    }

    void "test null user id"() {
        given:
            schedule.subscriptionId = null
            schedule.save()
        expect:
            schedule.hasErrors()
            schedule.errors["subscriptionId"].toString().contains("nullable")
    }
